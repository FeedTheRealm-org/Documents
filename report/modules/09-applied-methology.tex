...
entrega de ejecutable compilado, pero son todos sistemas pagos y se excedería en presupuesto para este proyecto para el equipo.
Por lo tanto se pactó con el tutor que para este entregable sería suficiente que se realice solo la parte de compilación 
del ejecutable del servidor manualmente, y el resto del \textit{pipeline} automatizado. En la cual, primero se genera
