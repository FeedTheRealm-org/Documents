...
Al comienzo de cada iteración, con una duración de dos semanas, se revisan las \textit{user stories} que deben encontrarse 
en progreso, así como las planificadas para la siguiente iteración de la misma versión. Todas ellas deben contar con una 
estimación aproximada de dificultad y, si superan cierto umbral, se dividen en otras historias o \textit{substories}.
