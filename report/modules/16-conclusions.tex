...
En paralelo, se desarrolló una infraestructura escalable con despliegue y descubrimiento automático de servidores, un conjunto de servicios centrales para
la gestión de usuarios, mundos, \textit{assets} y pagos, además de herramientas de CI/CD y monitoreo destinadas a facilitar la operación y el mantenimiento de la plataforma.
