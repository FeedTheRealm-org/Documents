...
utilizaba NetCode como framework de multijugador, cuya implementación comenzaba a escalar pero 
...
y mantenibilidad del proyecto. También se creó la landing page del proyecto, con información general 
del proyecto, un blog del desarrollo y links a las redes sociales. 
...
Lo unico que se logro resolver era arreglar bugs en el editor de mundos.
...
cosméticos con gemas. Se incorporó el Back Office para que los administradores puedan gestionar mundos, 
...
En infraestructura, se realizaron pruebas iniciales de carga con bots, se configuró MongoDB 
y se finalizó la integración con Nomad mediante HTTPS y dominio propio. Esta versión marcó el punto 
en que el proyecto comenzó a percibirse como un producto consolidado, lo que impactó positivamente 
...
calidad de vida (\textit{Quality of Life}). Se integró pruebas unitarias, de integración y de acceptacion
