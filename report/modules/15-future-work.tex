...
Para la moderación en chats, tambien pueden ser creados canales de prevención para evitar y censurar prácticas de 
...
mediante de forma manual o con la detección automática de las diferentes acciones que se mencionaron anteriormente.
...
De esta forma, se puede mejorar cuestiones como la \textit{availability} de la aplicación a través del uso de replicacion
