...
\paragraph{Moderacion de contenido y estrategias de \textit{baneo}}
...
\paragraph{Herramientas de AI para la generacion de mundos}
La idea es fomentar la creación organica de mundos, pero eso puede volverse una tarea tediosa si el mundo es muy grande 
o muy complejo. Es por eso, que nos pareció una buena idea integrar modelos de AI para que los jugadores puedan crear mundos, utilizando estos modelos. Los jugadores 
...
\paragraph{Detección de fraudes}
...
\paragraph{Migracion del \textit{core-service} hacia microservicios}
...
\paragraph{Migración de los servidores de mundos}
