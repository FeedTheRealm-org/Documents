...
\begin{itemize}
    ...
    \item \textbf{\texttt{generate\_docs.py}}: script Python auxiliar para la generación de documentos.
...
del repositorio. La compilación se realiza dentro de un contenedor Docker para no requerir una instalación local de \LaTeX{}. Los comandos 
