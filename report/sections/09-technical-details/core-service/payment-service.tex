...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{img/09-technical-details/core-service/payment-service-case-1.jpg}
    \caption{Diagrama de secuencia del flujo de compra de gemas.}    \label{fig:payment-service-case-1}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{img/09-technical-details/core-service/payment-service-case-2.jpg}
    \caption{Diagrama de secuencia del flujo de subscripcion.}    \label{fig:payment-service-case-2}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{img/09-technical-details/core-service/payment-service-case-3.jpg}
    \caption{Diagrama de secuencia de la compra de un cosmético.}    \label{fig:payment-service-case-3}
\end{figure}
