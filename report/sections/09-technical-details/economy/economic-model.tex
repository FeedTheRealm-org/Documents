...
\$3{,}75 por zona. El costo de \$3{,}75 por zona, se basa en que por máquina virtual se alojan 4 zonas, y cada máquina 
virtual tiene un costo mensual de \$15{,}00, más detalles en la sección de \nameref{sec:load-test}.
...
\begin{figure}[H]
  ...
  \caption{Resumen de los supuestos del modelo económico.}  \label{fig:assumptions}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Packs de gemas y su distribución en las transacciones.}  \label{fig:gems}
\end{figure}
...
\begin{figure}[H]
  \centering
  \begin{adjustbox}{width=1.20\textwidth, center}
    \includegraphics{img/08-implemented-solution/economy/users-scenarios.jpg}
  \end{adjustbox}
  \caption{Escenarios de crecimiento para usuarios.}  \label{fig:users-scenarios}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{adjustbox}
  \caption{Escenarios de crecimiento para creadores.}  \label{fig:creators-scenarios}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{adjustbox}
  \caption{Proyección de ingresos: Escenario Pesimista.}  \label{fig:scenarios-1}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{adjustbox}
  \caption{Proyección de ingresos: Escenario Base.}  \label{fig:scenarios-2}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{adjustbox}
  \caption{Proyección de ingresos: Escenario Optimista.}  \label{fig:scenarios-3}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{adjustbox}
  \caption{Proyección de ingresos: Escenario Arranque Lento.}  \label{fig:scenarios-4}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{adjustbox}
  \caption{Proyección de ingresos: Escenario Lanzamiento.}  \label{fig:scenarios-5}
\end{figure}
