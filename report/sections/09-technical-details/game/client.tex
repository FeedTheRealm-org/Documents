...
\textit{Assemblies} y \texttt{Vcontainer}, esto se explica en la sección de \nameref{sec:unity-structure}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{img/09-technical-details/game/client-init.jpg}
