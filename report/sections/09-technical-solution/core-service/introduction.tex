...
\begin{figure}[H]
    ...
    \begin{adjustbox}{width=\textwidth, center}
        \includegraphics{img/08-implemented-solution/core-service/core-service-package.jpg}
    \end{adjustbox}
    \caption{Diagrama de paquetes del \textit{core service}}
    \label{fig:core-service-package}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{adjustbox}{width=0.3\textwidth, center}
        \includegraphics{img/08-implemented-solution/core-service/service-layers.jpg}
    \end{adjustbox}
    \caption{Diagrama donde se ven las capas (o \textit{layers}) de un servicio}
