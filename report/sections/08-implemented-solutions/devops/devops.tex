...
Luego de ser compiladas, se comprimen y se realiza un \textit{Release} de la nueva versión a través del sistema \textbf{backoffice} que se abordara en la corresponiente sección.
