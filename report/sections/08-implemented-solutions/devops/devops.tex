...
En esta sección se detallan las decisiones infraestructurales tomadas para llevar la arquitectura previamente mencionada, a la práctica teniendo en cuenta el uso de recursos de las aplicaciones,
...
\begin{itemize}
    \item \textbf{Nomad server node - EC2}: Este tipo de nodos son los que contienen mínimamente
        una instancia de \textit{nomad server} y otra de \textit{consul server}. % TODO(fix): faltaria un breve resumen de que es consul no?
