...
y se ejecuta automaticamente el \textit{pipeline} que obtiene la imagen de dicho alojamiento y (haciendo el mismo procedimiento del core-service explicado anteriormente)
