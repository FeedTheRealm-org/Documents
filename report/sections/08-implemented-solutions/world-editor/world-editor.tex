...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/world-editor-intro.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/empty-zone.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/structure-transform.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/downloading-default.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/import-model-1.png}
    \caption{Panel de importación de modelos 3D.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/import-model-2.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/spawner-player.png}
  \caption{Generador de jugadores colocado en la escena.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/spawner-npc.png}
  \caption{Generador de NPCs colocado en la escena.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/spawner-enemy.png}
...
que permiten a los creadores manipular visualmente la posición, rotación y escala de los objetos colocados en la escena.
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/gizmos.png}
