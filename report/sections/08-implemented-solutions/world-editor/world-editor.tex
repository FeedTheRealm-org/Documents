...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/empty-zone.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/structure-transform.jpg}
    \caption{Estructura seleccionada.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/cube-collider.jpg}
    \caption{Estructuras con colisionador de tipo cubo con transformaciones aplicadas.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/downloading-default.jpg}
    \caption{Panel de descarga de contenido predeterminado.}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/spawner-player.jpg}
  \caption{Generador de jugadores colocado en la escena.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/spawner-npc.jpg}
  \caption{Generador de NPCs colocado en la escena.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/spawner-enemy.jpg}
  \caption{Generador de enemigos colocado en la escena.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{img/08-implemented-solution/world-editor/transactions.jpg}
\caption{Panel de transacciones.}
