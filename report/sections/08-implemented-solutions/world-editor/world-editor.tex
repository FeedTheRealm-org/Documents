...
\begin{figure}[H]
  ...
  \caption{Un ejemplo demundo en construcción dentro del editor}
...
\begin{itemize}
  ...
  \label{fig:structure-transform}
\end{figure}

  \vspace{0.25cm}

  Al incializar el juego por primera vez, se verá que el usuario no tiene estructuras disponibles para colocar, 
  ...
  \label{fig:default-content}
\end{figure}

  \vspace{0.25cm}

  Uno de los features mas enriquecedores del editor es la posibilidad de importar modelos 3D personalizados, 
  lo que permite a los creadores diseñar y utilizar sus propios assets visuales en el juego. Para lograr esto, se integró la librería \texttt{GLTFast}, que facilita la carga de modelos en formato \texttt{.glb} 
