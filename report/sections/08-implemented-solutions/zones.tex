...
Los creadores pueden seleccionar entre distintas texturas predeterminadas (Asumiendo que el ususario ya importó el contentido predeterminado que se verá más adelante) 
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{img/08-implemented-solution/product/edited-zone.jpg}
