...
\begin{figure}[h]
    ...
    \begin{adjustbox}{width=1.10\textwidth, center}
        \includegraphics{img/08-implemented-solution/core-service/world-service-case-1.jpg}
    \end{adjustbox}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{img/08-implemented-solution/core-service/world-service-case-2.jpg}
