...
\begin{figure}[h]
    ...
    \begin{adjustbox}{width=\textwidth, center}
        \includegraphics{img/08-implemented-solution/core-service/core-service-package.png}
    \end{adjustbox}
...
\begin{figure}[h]
    ...
    \begin{adjustbox}{width=0.3\textwidth, center}
        \includegraphics{img/08-implemented-solution/core-service/service-layers.png}
    \end{adjustbox}
