...
Nuestra aplicación presentan dos niveles o tipos de autorización. Por un lado los usuarios o \textit{players}, 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{img/08-implemented-solution/core-service/auth-service-case-1.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{img/08-implemented-solution/core-service/auth-service-case-2.jpg}
