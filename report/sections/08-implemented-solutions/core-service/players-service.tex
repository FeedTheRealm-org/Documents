\subsubsection{\textit{Player service}}
...
Cada jugador dispone de un personaje asociado a su cuenta, cuya información puede actualizarse mediante
\texttt{PATCH /player/character}. La petición debe incluir el nombre del personaje y adicionalmente su biografía, la 
\textit{skin}, cabello y ojos.  El nombre debe tener entre 3 y 24 caracteres, no puede contener espacios ni caracteres 
especiales inválidos, y debe ser único en el sistema; si ya está en uso, se retorna un error de conflicto. La biografía 
admite hasta 256 caracteres. Los colores son opcionales y, de no proporcionarse, se aplican valores por defecto.
\vspace{0.25cm}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\textwidth]{img/08-implemented-solution/core-service/players-service-case-1.png}
