...
con el archivo comprimido bajo el campo \texttt{file}. El sistema valida que el nombre de la aplicación y el sistema
operativo correspondan a valores permitidos, que la versión cumpla el formato \texttt{vX.Y.Z} y que el archivo sea
...
\hline
\caption{\textit{Endpoints} del \textit{exports service}}
\label{tab:exports-endpoints}
\end{longtable}
