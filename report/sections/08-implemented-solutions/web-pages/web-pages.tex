...
Se implementó una página web de libre acceso utilizando \textit{React} y \textit{Typescript}, con el objetivo de publicar
información sobre \textbf{Feed the Realm}, detalles de su desarrollo, videoclips e imágenes y opciones de descarga de las aplicaciones a
...
Se implementó una segunda página web utilizando \textit{React} y \textit{Typescript} para uso administrativo por parte del equipo de desarrollo,
con el objetivo de reducir tiempos de operaciones manuales como lo pueden ser lanzar o apagar servidores manualmente,
...
o filtrar por estados, en este caso \textit{online}, \textit{offline} o \textit{degraded}.
...
con la posibilidad de lanzar o parar los servidores correspondientes a las mismas.
