...
para la creación de mundos dinámicos y brindar la aparencia de un mundo con vida. 
...
Dentro de los \textit{NPCs} se encuentran dos subtipos: los \textit{NPCs} pasivos y los \textit{NPCs} 
