...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{img/08-implemented-solution/product/agresive-creation.jpg}
  \caption{Editor de mundos para la creación de NPCs agresivos.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{img/08-implemented-solution/product/agresive-in-game.jpg}
