...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{img/08-implemented-solution/world-editor/portal.jpg}
\caption{Portal colocado en la escena.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{img/08-implemented-solution/product/portals.jpg}
...
\caption{Edicion de un cofre.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{img/08-implemented-solution/product/game-chest.jpg}
