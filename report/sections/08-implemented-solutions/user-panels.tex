...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{img/08-implemented-solution/product/world-feed.jpg}
    \caption{Captura de pantalla del navegador de mundos}
    \label{fig:world-feed}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{img/08-implemented-solution/product/character-edit.jpg}
    \caption{Captura de pantalla del editor de personajes}
    \label{fig:character-edit}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Captura de pantalla de la tienda de gemas}
    \label{fig:gem-store}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{img/08-implemented-solution/product/settings.jpg}
    \caption{Captura de pantalla de la configuración}
    \label{fig:settings}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Captura de pantalla del HUD}
    \label{fig:hud}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{img/08-implemented-solution/product/inventory.jpg}
    \caption{Captura de pantalla del inventario}
    \label{fig:inventory}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Captura de pantalla del diario de misiones}
    \label{fig:quest-journal}
\end{figure}


Por último, dentro de los mundos pueden existir estructuras con la particularidad de ser interactuables como tiendas, 
donde los jugadores pueden comprar items del mundo, utilizando las monedas de oro que pueden obtenerse en el mundo, 
y también si el creador del mundo lo ha configurado, pueden comprar cosméticos utilizando gemas.


\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{img/08-implemented-solution/product/shop.jpg}
    \caption{Captura de pantalla de la tienda}
    \label{fig:shop}
\end{figure}
