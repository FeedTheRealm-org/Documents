...
Los parámetros del modelo económico se organizan en cuatro grupos. En primer lugar, los supuestos sobre \textbf{gemas} 
establecen que el creador retiene el 10\% de cada venta cosmética, y que la conversión es de \$0{,}25 por gema. En cuanto 
a las \textbf{suscripciones}, el precio por zona es de \$5{,}00 mensuales, con un costo de mantenimiento estimado de 
...
Respecto a las \textbf{comisiones de Stripe}, se aplica una tarifa variable del 2{,}90\% más \$0{,}30 fijos por transacción. 
Finalmente, los supuestos de \textbf{comportamiento de compra} indican que cada usuario realiza en promedio 1{,}5 transacciones 
mensuales, que los creadores mantienen 2{,}5 zonas activas, y que el 90\% de las gemas adquiridas son efectivamente utilizadas.

\begin{figure}[h]
  \centering
  \includegraphics[width=0.65\textwidth]{img/08-implemented-solution/economy/assumptions.png}
...
\begin{figure}[H]
  \centering
  \begin{adjustbox}{width=1.10\textwidth, center}
    \includegraphics{img/08-implemented-solution/economy/scenarios/scenario-1.png}
  \end{adjustbox}
...
\begin{figure}[H]
  \centering
  \begin{adjustbox}{width=1.10\textwidth, center}
    \includegraphics{img/08-implemented-solution/economy/scenarios/scenario-2.png}
  \end{adjustbox}
...
\begin{figure}[H]
  \centering
  \begin{adjustbox}{width=1.10\textwidth, center}
    \includegraphics{img/08-implemented-solution/economy/scenarios/scenario-3.png}
  \end{adjustbox}
...
\begin{figure}[H]
  \centering
  \begin{adjustbox}{width=1.10\textwidth, center}
    \includegraphics{img/08-implemented-solution/economy/scenarios/scenario-4.png}
  \end{adjustbox}
...
\begin{figure}[H]
  \centering
  \begin{adjustbox}{width=1.10\textwidth, center}
    \includegraphics{img/08-implemented-solution/economy/scenarios/scenario-5.png}
  \end{adjustbox}
